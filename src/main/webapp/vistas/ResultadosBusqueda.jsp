        ...
        <body>
            ...
            <section>
                ...
                <div class="admin-content">
                                ...
                                <div class="movie-card-content">
                                    ...
                                    <div class="movie-card-actions">
                                        <c:if test="${not empty pelicula.trailer}">
                                            <a href="${pelicula.trailer}" target="_blank" class="btn-view">Ver
                                                Tráiler</a>
                                        </c:if>
                                        <a href="${pageContext.request.contextPath}/visualizarPeliculaController?action=ampliarPelicula&idPelicula=${pelicula.id}"
                    ...
                    <!-- ENLACE PARA VOLVER -->
                    <a href="${pageContext.request.contextPath}/index.html" class="back-link">← Volver al catálogo</a>
